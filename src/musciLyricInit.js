...
import syncProgressBar from "./progressBarInit";
...
//     if(lyric === ""){
//         if (localStorage.getItem("progressState") === "super"){
//             if (audioPlayer[0].paused !== true){
//                 nextMusic(1).then()
//             }else {
//             }
//         }else if (localStorage.getItem("progressState") === "lesser"){
...
//             }
//             audioPlayer.on("timeupdate",()=>{
//                 syncProgressBar(lyricDuration, currentTime)
//             })
//         }
//
//     }else{
//         if (currentTime >= lyricArray[lyricArray.length - 1][0]){
//             currentLyricIndex = length - 1
